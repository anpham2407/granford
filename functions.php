...
function granford_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Menu', 'twentytwentyone' ),
			'id'            => 'sidebar-2',
			'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'End Footer', 'twentytwentyone' ),
			'id'            => 'copy-right',
			'description'   => esc_html__( 'Add widgets here to appear in end footer', 'twentytwentyone' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s nav-right-side">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
